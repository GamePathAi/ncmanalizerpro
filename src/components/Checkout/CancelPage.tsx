      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-gradient-to-br from-slate-800 to-gray-800 border border-gray-700 rounded-xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6">O que aconteceu?</h2>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-gray-800 border border-gray-700 rounded-xl p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-purple-900/30 border border-purple-500/30 rounded-lg p-6">
                <h3 className="text-purple-400 font-semibold mb-3">🛡️ Pagamento Seguro</h3>
        ...
        {/* Benefícios Perdidos */}
        <div className="mt-8 bg-gradient-to-br from-slate-800 to-gray-800 border border-gray-700 rounded-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-white font-semibold mb-2">Economia de até 40%</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-white font-semibold mb-2">Análise Instantânea</h3>
              <p className="text-gray-400 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-white font-semibold mb-2">Relatórios Detalhados</h3>
              <p className="text-gray-400 text-sm">
        ...
        <div className="mt-8 bg-gradient-to-br from-slate-800 to-gray-800 border border-gray-700 rounded-xl p-8">
          ...
          <div className="space-y-4">
            <div className="border-b border-gray-600 pb-4">
              <h3 className="text-white font-semibold mb-2">Meus dados estão seguros?</h3>
              <p className="text-gray-300 text-sm">
            ...
            <div className="border-b border-gray-600 pb-4">
              <h3 className="text-white font-semibold mb-2">Posso tentar com outro cartão?</h3>
              <p className="text-gray-300 text-sm">
            ...
            <div>
              <h3 className="text-white font-semibold mb-2">E se o problema persistir?</h3>
              <p className="text-gray-300 text-sm">
